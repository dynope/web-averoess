$(window).on('scroll', function () {
    ...
    if (scroll_top > 40) {
        ...
        $('#navbar-brand-tittle').addClass('text-dark');
    }
    if (scroll_top < 40) {
        $('.navbar').removeClass('bg-white');
        $('.navbar').addClass('bg-body-light');
        $('#navbar-brand-tittle').addClass('text-white');
        $('#navbar-brand-tittle').removeClass('text-dark');

    }
    else {
        $('.navbar').removeClass('bg-body-light');
        $('#navbar-brand-tittle').removeClass('text-white');
    }
})
